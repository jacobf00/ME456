...
classdef SerialLink2 < handle & dynamicprops % & matlab.mixin.Copyable
    ...
    methods
        function r = SerialLink2(varargin)
...
%                 line = horzcat(s_grav, s_base, s_tool);
        ...
        % See also:  DH
            ...
            rmdh = SerialLink2(link, 'base', r.base, 'tool', tool);
        end
        ...
        % See also:  MDH
            ...
            rdh = SerialLink2(link, 'base', base, 'tool', r.tool);
        end
